  ...
  const renderVehicleCard = (vehicle: QuickSidebarProps["vehicles"][number]) => {
    ...
    return (
      <div
        ...
        className="rounded-xl border border-white/10 bg-[#10121a] shadow-[0_10px_20px_rgba(0,0,0,0.35)] cursor-pointer"
        ...
        {activeTab === "vehicles" ? (
          sortedVehicles.length ? (
            <div className="space-y-3">
              ...
              {listTab === "all" && (
                <div className="rounded-2xl border border-white/10 bg-[#0c0f16] p-3 space-y-3">
                  ...
                  <div className="space-y-2">
                    {groupedByCompany.map((company) => (
                      <details
                        ...
                        className="rounded-xl border border-white/10 bg-[#10121a] px-3 py-2"
                      >
